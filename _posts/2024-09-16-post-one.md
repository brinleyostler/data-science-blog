...
*The mtcars dataset contains fuel consumption and automobile performance data for 32 cars, extracted from the 1974 Motor Trend magazine.*
...
Let’s enhance the plot by adding color to the points:
```r
ggplot(data = mtcars, mapping = aes(x = wt, y = mpg)) +
...
<figure>
	<img src="{{site.url}}/{{site.baseurl}}/assets/img/scatter-color1.jpg" alt=""> 
	<figcaption>Figure 1. - Scatterplot with color</figcaption>
</figure>
...
<figure>
	<img src="{{site.url}}/{{site.baseurl}}/assets/img/scatter-color2.jpg" alt=""> 
	<figcaption>Figure 1. - Scatterplot with colored variables</figcaption>
</figure>
...
<figure>
	<img src="{{site.url}}/{{site.baseurl}}/assets/img/scatter-legend1.jpg" alt=""> 
	<figcaption>Figure 1. - Labeled scatterplot and legend</figcaption>
</figure>


### Step Four: Adding a Trendline
You can add a smooth trendline using geom_smooth(): 
```r
ggplot(mtcars, aes(x = wt, y = mpg)) +
  geom_point(aes(color = factor(cyl))) +
...
<figure>
	<img src="{{site.url}}/{{site.baseurl}}/assets/img/scatter-smooth1.jpg" alt=""> 
	<figcaption>Figure 1. - Scatterplot and smooth trendline</figcaption>
</figure>


We can also make this trendline linear by adjusting the method in our geom_smooth() argument.
```r
ggplot(mtcars, aes(x = wt, y = mpg)) +
  geom_point(aes(color = factor(cyl))) +
...
<figure>
	<img src="{{site.url}}/{{site.baseurl}}/assets/img/scatter-linear1.jpg" alt=""> 
	<figcaption>Figure 1. - Scatterplot and linear trendline</figcaption>
</figure>



### Step Five: Changing the Theme
Finally, let's switch up the look of our graph by implementing a different theme.
```r
ggplot(mtcars, aes(x = wt, y = mpg)) +
  geom_point(aes(color = factor(cyl))) +
  geom_smooth(method = "lm", se = FALSE, color = "black") +
...
<figure>
	<img src="{{site.url}}/{{site.baseurl}}/assets/img/scatter-theme1.jpg" alt=""> 
	<figcaption>Figure 1. - Scatterplot and linear trendline</figcaption>
</figure>
